 ...
 <div class="container col-xs-4 col-xs-offset-4" style="top:15px;">
    <div class="v-center">
        <div class="row jumbotron v-center" style="padding-right:40px;padding-left:40px; height:620px;">
            ...
            <form class="form-signin" method="post" action="loginh">
                ...
                <input type="email" class="form-control" name="username" id="user" placeholder="Email Address" required="true" autofocus=""/>
