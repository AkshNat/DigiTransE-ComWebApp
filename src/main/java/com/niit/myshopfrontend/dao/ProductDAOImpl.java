...
public class ProductDAOImpl implements ProductDAO {
	...
	public List<Product> getProduct() {
		...
		Product p6 = new Product("P-MTO34","cat3", "OTG Cable","Length 0.127 m  Flat Cable Connector One: USB Services 6 Months Warranty against Manufacturing Defect 10 Days Replacement Policy Description Note:-Kindly Check compatibility of the cable with your Phone and Tablet.", 120.50, false);
		Product p7 = new Product("P-RX10","cat1", "Point and shoot", "Approx. 20.1 effective megapixel 13.2 x 8.8 mm (1.0-type) Exmor® RS™ CMOS sensor Bright ZEISS® Vario-Sonnar T* 24-600 mm1 F2.4-4 lens Extra-high-speed shooting capability",1225.0,false);
		Product p8 = new Product("P-HTTP09","cat2", "HTC One","The One X9 Dual SIM boasts a metal unibody design, with a slim body. HTC One X9 flaunts a 5.5-inch full HD (1080p) IPS display. It comes with MediaTek’s Helio X10 (MT6795T) octa-core SoC clocked at 2.2GHz. It is paired with 3GB of RAM, 32GB of internal storage and a microSD card slot with support up to 2TB. It sports a 13-megapixel rear snapper with OIS, support for 4K video recording and dual-tone LED flash. Other connectivity options include dual-SIM card support, 4G LTE, Bluetooth, Wi-Fi and GPS.", 15999.99, true);
